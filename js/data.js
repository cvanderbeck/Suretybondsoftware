...
window.DB = (() => {
  ...
  const sampleData = () => ({
    ...
    partners: [
      { id: 'P-01', name: 'AmTrust Group',
        writingCompany: 'Developers Surety and Indemnity Company',
        naic: '12718',
        stateOfIncorporation: 'California',
        businessAddress: '17771 Cowan, Suite 100, Irvine, CA 92614',
        treasuryUnderwritingLimit: 1492000,
        treasuryProfileUrl: 'https://fiscal.treasury.gov/surety-bonds/list-certified-companies.html',
        rating: 'A- IX',
        appetite: 'Contract, commercial, and license/permit bonds — small to mid-size accounts. Contractor license, notary, court, and probate bonds a focus.',
        contactName: 'Underwriting Desk',
        email: 'newbusiness@amtrustsurety.example',
        phone: '(877) 528-7878',
        portalUrl: 'https://amtrustsurety.example/producers',
        commissionRate: 30, active: true,
        rateOptions: [
          { id: 'R-P01-1', name: '$25/thousand — Contract standard', type: 'per-thousand', rate: 25, minPremium: 250 },
          { id: 'R-P01-2', name: '$30/thousand — License/Permit',    type: 'per-thousand', rate: 30, minPremium: 100 },
          { id: 'R-P01-3', name: 'Notary — flat $50',                type: 'flat',         rate: 50,  minPremium: 50 },
          { id: 'R-P01-4', name: 'Bid Bond — no charge',             type: 'flat',         rate: 0,   minPremium: 0 },
        ],
        commissionOptions: [
          { id: 'C-P01-1', name: '25% standard',        rate: 25 },
          { id: 'C-P01-2', name: '30% preferred',       rate: 30 },
          { id: 'C-P01-3', name: '35% high-volume',     rate: 35 },
        ],
        forms: [
          { id: 'FRM-P01-1', name: 'AmTrust Producer Agreement',      category: 'Producer Agreement', version: 'v2024.1', effectiveDate: '2024-03-01', expiresDate: '2027-02-28', size: 720*1024, type: 'application/pdf' },
          { id: 'FRM-P01-2', name: 'Contract Bond Application',       category: 'Application',        version: 'v2025.1', effectiveDate: '2025-01-01', expiresDate: '2027-12-31', size: 195*1024, type: 'application/pdf' },
          { id: 'FRM-P01-3', name: 'Power of Attorney',               category: 'POA',                version: 'v2025.2', effectiveDate: '2025-07-01', expiresDate: '2026-06-30', size: 145*1024, type: 'application/pdf', notes: 'EXPIRING soon.' },
          { id: 'FRM-P01-4', name: 'License Bond Rate Sheet',         category: 'Rate Sheet',         version: 'v2026',    effectiveDate: '2026-01-01', expiresDate: '2026-12-31', size: 105*1024, type: 'application/pdf' },
        ],
      },
      { id: 'P-02', name: 'Liberty Mutual Surety',
        writingCompany: 'The Ohio Casualty Insurance Company',
        naic: '24074',
        stateOfIncorporation: 'New Hampshire',
        businessAddress: '175 Berkeley Street, Boston, MA 02116',
        treasuryUnderwritingLimit: 283381000,
        treasuryProfileUrl: 'https://fiscal.treasury.gov/surety-bonds/list-certified-companies.html',
        rating: 'A XV',
        appetite: 'Mid-to-large contract, marine, mechanical, and commercial surety. Higher single/aggregate capacity for qualified GCs.',
        contactName: 'Priya Subramanian',
        email: 'psubramanian@lms.example',
        phone: '(800) 555-0102',
        portalUrl: 'https://lms.example/portal',
        commissionRate: 25, active: true,
        rateOptions: [
          { id: 'R-P02-1', name: '$15/thousand slide (Preferred)',   type: 'slide',        rate: 0, minPremium: 500,
            slide: [{ upTo: 500000, rate: 15 }, { upTo: 1000000, rate: 13 }, { upTo: 2500000, rate: 11 }, { upTo: null, rate: 8 }], notes: 'For A-rated principals.' },
          { id: 'R-P02-2', name: '$20/thousand flat',                type: 'per-thousand', rate: 20, minPremium: 500 },
          { id: 'R-P02-3', name: '$25/thousand flat (Substandard)',  type: 'per-thousand', rate: 25, minPremium: 500 },
      ...
      { id: 'P-03', name: 'Old Republic Surety',
        writingCompany: 'Old Republic Insurance Company / Old Republic Surety Company',
        naic: '24147 (Insurance) / 40444 (Surety)',
        stateOfIncorporation: 'Pennsylvania (Insurance) / Wisconsin (Surety)',
        businessAddress: 'Old Republic Insurance: PO Box 789, Greensburg, PA 15601-0789 · Old Republic Surety: 445 S Moorland Rd, Brookfield, WI 53005',
        treasuryUnderwritingLimit: 87492000,
        treasuryProfileUrl: 'https://fiscal.treasury.gov/surety-bonds/list-certified-companies.html',
        rating: 'A+ XV',
        appetite: 'Contract, license/permit, freight broker (BMC-84), small commercial. Old Republic Surety carries the smaller book; Old Republic Insurance carries large contract.',
        contactName: 'James O’Connor',
        email: 'joconnor@oldrepublic.example',
        phone: '(800) 555-0103',
        portalUrl: 'https://oldrepublic.example/agent',
        commissionRate: 30, active: true,
        rateOptions: [
          { id: 'R-P03-1', name: '$15/thousand slide (Large Contract, OR Insurance Co.)', type: 'slide',   rate: 0, minPremium: 500,
            slide: [{ upTo: 500000, rate: 15 }, { upTo: 1000000, rate: 12.50 }, { upTo: 2500000, rate: 10 }, { upTo: null, rate: 7.50 }] },
          { id: 'R-P03-2', name: '$25/thousand — License Bond',      type: 'per-thousand', rate: 25, minPremium: 100, notes: 'Standard state license bonds.' },
          { id: 'R-P03-3', name: '$30/thousand — License Bond (SubStd)', type: 'per-thousand', rate: 30, minPremium: 100 },
          { id: 'R-P03-4', name: 'Contractor License — flat $200',   type: 'flat',         rate: 200, minPremium: 200, notes: 'CSLB / OR CCB standard.' },
          { id: 'R-P03-5', name: 'Freight Broker (BMC-84)',          type: 'per-thousand', rate: 25, minPremium: 1875, notes: '$75K FMCSA — annual premium.' },
        ],
        commissionOptions: [
      ...
      { id: 'P-04', name: 'Merchants Bonding Company (Mutual)',
        writingCompany: 'Merchants Bonding Company (Mutual)',
        naic: '14494',
        stateOfIncorporation: 'Iowa',
        businessAddress: 'P.O. Box 14498, Des Moines, IA 50306-3498',
        treasuryUnderwritingLimit: 29377000,
        treasuryProfileUrl: 'https://fiscal.treasury.gov/surety-bonds/list-certified-companies.html',
        rating: 'A- IX',
        appetite: 'Small-to-mid contract bonds, commercial license, notary. Standard producer commission 30–35%. All 50 states.',
        contactName: 'Erica Chen',
        email: 'erica@merchantsbonding.example',
        phone: '(515) 243-8171',
        portalUrl: 'https://merchantsbonding.example/producer',
        commissionRate: 30, active: true,
        rateOptions: [
      ...
      { id: 'P-05', name: 'Capitol Indemnity Corporation',
        writingCompany: 'Capitol Indemnity Corporation',
        naic: '10472',
        stateOfIncorporation: 'Wisconsin',
        businessAddress: 'P.O. Box 5900, Madison, WI 53705-0900 (mailing) · 1600 Aspen Commons, Middleton, WI 53562 (offices)',
        treasuryUnderwritingLimit: 24924000,
        treasuryProfileUrl: 'https://fiscal.treasury.gov/surety-bonds/list-certified-companies.html',
        rating: 'A- IX',
        appetite: 'Commercial and license/permit surety, notary, contract up to mid-market. All 50 states plus DC.',
        contactName: 'Linda Park',
        email: 'lpark@capitolindemnity.example',
        phone: '(608) 829-4200',
        portalUrl: 'https://capitolindemnity.example/agentportal',
        commissionRate: 30, active: true,
        rateOptions: [
          ...
          { id: 'R-P05-3', name: '$25/thousand — Commercial License', type: 'per-thousand', rate: 25, minPremium: 100 },
          { id: 'R-P05-4', name: '$30/thousand — Small Contract',     type: 'per-thousand', rate: 30, minPremium: 250 },
        ],
        commissionOptions: [
          { id: 'C-P05-1', name: '30% standard',        rate: 30 },
          { id: 'C-P05-2', name: '35% high-volume',     rate: 35 },
        ],
        forms: [
          { id: 'FRM-P05-1', name: 'Capitol Indemnity Producer Agreement', category: 'Producer Agreement', version: 'v2024',    effectiveDate: '2024-05-01', expiresDate: '2027-04-30', size: 510*1024, type: 'application/pdf' },
      ...
      { id: 'P-06', name: 'Westfield Insurance',
        writingCompany: 'Westfield National Insurance Company',
        naic: '24120',
        stateOfIncorporation: 'Ohio',
        businessAddress: 'One Park Circle, Westfield Center, OH 44251',
        treasuryUnderwritingLimit: null,
        treasuryProfileUrl: 'https://fiscal.treasury.gov/surety-bonds/list-certified-companies.html',
        rating: 'A XIV',
        appetite: 'Contract, subdivision, court, and commercial surety. Preferred for mid-market Midwest GCs and developers.',
        contactName: 'Robert Tan',
        email: 'rtan@westfield.example',
        phone: '(800) 243-0210',
        portalUrl: 'https://westfield.example/agent',
        commissionRate: 25, active: true,
        rateOptions: [
        ...
        forms: [
          { id: 'FRM-P06-1', name: 'Westfield Producer Agreement',      category: 'Producer Agreement', version: 'v2024.2', effectiveDate: '2024-10-01', expiresDate: '2027-09-30', size: 720*1024, type: 'application/pdf' },
      ...
      { id: 'P-07', name: 'Lexington National Insurance Corporation',
        writingCompany: 'Lexington National Insurance Corporation',
        naic: '40371',
        stateOfIncorporation: 'Maryland',
        businessAddress: '2 Radnor Corporate Center, Suite 250, Radnor, PA / Historical Stuart, FL underwriting office',
        treasuryUnderwritingLimit: 423000,
        treasuryProfileUrl: 'https://fiscal.treasury.gov/surety-bonds/list-certified-companies.html',
        rating: 'A- VII',
        appetite: 'Specialty surety and bail bonds primarily. Licensed CA, CO, DE, FL, IN, MD, MS, NJ, PA, and select others — confirm state before submitting.',
        contactName: 'Underwriting Desk',
        email: 'newbusiness@lnic.example',
        phone: '(410) 625-0800',
        portalUrl: 'https://lnic.example/producers',
        commissionRate: 25, active: true,
        rateOptions: [
          { id: 'R-P07-1', name: 'Bail Bond — 10% of penal sum', type: 'per-thousand', rate: 100, minPremium: 100, notes: 'Bail premium is typically 10% of the bond amount, non-refundable.' },
          { id: 'R-P07-2', name: 'Court/Specialty — $30/thousand', type: 'per-thousand', rate: 30, minPremium: 250 },
        ],
        commissionOptions: [
          { id: 'C-P07-1', name: '25% standard',        rate: 25 },
        ],
        forms: [
          { id: 'FRM-P07-1', name: 'LNIC Producer Agreement',           category: 'Producer Agreement', version: 'v2024',    effectiveDate: '2024-04-01', expiresDate: '2027-03-31', size: 460*1024, type: 'application/pdf' },
          { id: 'FRM-P07-2', name: 'Bail Bond Form',                    category: 'Bond Form',          version: 'v2024.1', effectiveDate: '2024-01-01', expiresDate: '2027-01-01', size: 165*1024, type: 'application/pdf' },
          { id: 'FRM-P07-3', name: 'Power of Attorney',                 category: 'POA',                version: 'v2026',    effectiveDate: '2026-01-01', expiresDate: '2026-12-31', size: 130*1024, type: 'application/pdf' },
        ],
      },
      { id: 'P-08', name: 'Intact Insurance Specialty Solutions',
        writingCompany: 'Atlantic Specialty Insurance Company',
        naic: '27154',
        stateOfIncorporation: 'New York',
        businessAddress: '605 Highway 169 North, Suite 800, Plymouth, MN 55441',
        treasuryUnderwritingLimit: 62660000,
        treasuryProfileUrl: 'https://fiscal.treasury.gov/surety-bonds/list-certified-companies.html',
        rating: 'A+ XIV',
        appetite: 'Contract, commercial, and specialty surety. Public entity, transportation, energy. Formerly OneBeacon before Intact acquisition (2017).',
        contactName: 'Underwriting Desk',
        email: 'surety@intactspecialty.example',
        phone: '(781) 332-7000',
        portalUrl: 'https://intactspecialty.example/producers',
        commissionRate: 25, active: true,
        rateOptions: [
          { id: 'R-P08-1', name: '$15/thousand slide — Contract', type: 'slide',   rate: 0, minPremium: 500,
            slide: [{ upTo: 500000, rate: 15 }, { upTo: 1000000, rate: 12.50 }, { upTo: 2500000, rate: 10 }, { upTo: null, rate: 8 }] },
          { id: 'R-P08-2', name: '$20/thousand — Commercial',     type: 'per-thousand', rate: 20, minPremium: 500 },
          { id: 'R-P08-3', name: 'Public Entity — $12/thousand',  type: 'per-thousand', rate: 12, minPremium: 500 },
        ],
        commissionOptions: [
          { id: 'C-P08-1', name: '25% standard',        rate: 25 },
          { id: 'C-P08-2', name: '30% preferred',       rate: 30 },
        ],
        forms: [
          { id: 'FRM-P08-1', name: 'Intact/Atlantic Specialty Producer Agreement', category: 'Producer Agreement', version: 'v2024.1', effectiveDate: '2024-06-01', expiresDate: '2027-05-31', size: 680*1024, type: 'application/pdf' },
          { id: 'FRM-P08-2', name: 'Contract Bond Form',                          category: 'Bond Form',          version: 'v2024.2', effectiveDate: '2024-08-01', expiresDate: '2027-07-31', size: 310*1024, type: 'application/pdf' },
          { id: 'FRM-P08-3', name: 'Power of Attorney',                            category: 'POA',                version: 'v2025.1', effectiveDate: '2025-01-01', expiresDate: '2026-12-31', size: 155*1024, type: 'application/pdf' },
          { id: 'FRM-P08-4', name: 'Appetite Guide 2026',                          category: 'Appetite Guide',     version: 'v2026',    effectiveDate: '2026-01-01', expiresDate: null,        size: 480*1024, type: 'application/pdf' },
        ],
      },
    ],
    pipelineStages: [
    ...
    pipeline: [
      ...
      { id: 'PL-002', stage: 'Pre-Qualification',             accountId: 'A-1002', bondType: 'Payment & Performance', amount: 800000,  obligee: 'Marion County',         dueDate: '2026-05-22', notes: 'Pulling financials and WIP for pre-qual',           producer: 'CV', probability: 40, bidResult: 'pending',
        ...
        activity: [
          { id: 'AC-002', date: '2026-05-09T09:10', author: 'Courtney V.', type: 'note', text: 'Requested updated WIP from Cascade for pre-qual.' },
        ],
        tasks: [
      ...
      { id: 'PL-004', stage: 'Submitted to Underwriter',      accountId: 'A-1002', bondType: 'Bid',                   amount: 48000,   obligee: 'Salem-Keizer SD',       dueDate: '2026-05-15', notes: 'Sent to Liberty UW 5/12 — awaiting acknowledgement', producer: 'CV', probability: 60, bidResult: 'pending',
        ...
        activity: [
          { id: 'AC-003', date: '2026-05-12T14:30', author: 'Courtney V.', type: 'email', subject: 'McKay HS HVAC — submission', text: 'Sent submission package to Liberty Mutual UW.' },
        ] },
      ...
      { id: 'PL-007', stage: 'Awarded - Ready to Issue',      accountId: 'A-1004', bondType: 'Payment & Performance', amount: 875000,  obligee: 'Port of Seattle',       dueDate: '2026-05-20', notes: 'Awarded — convert to bond and issue',                producer: 'CV', probability: 100, bidResult: 'awarded',
        ...
        typeSpecific: { contractType: 'Lump Sum', performancePct: 100, paymentPct: 100, warrantyPeriodMonths: 24 },
        activity: [
          { id: 'AC-004', date: '2026-05-20T15:30', author: 'Courtney V.', type: 'bid_result', subject: 'Result: Awarded — we won', text: 'Port of Seattle confirmed award. Notice to proceed issued.' },
        ] },
      { id: 'PL-008', stage: 'Approved – Pending Bid Results',accountId: 'A-1007', bondType: 'Bid',                   amount: 42000,   obligee: 'Sacramento Regional Transit', dueDate: '2026-05-08', notes: 'Bid opened — we were 2nd lowest',           producer: 'CV', probability: 0,   bidResult: 'not_low',
        ...
        activity: [
          { id: 'AC-005', date: '2026-05-08T16:00', author: 'Courtney V.', type: 'bid_result', subject: 'Result: Not Low — lost on price', text: 'Bayside Electric was low at $392,450. We were 2nd of 4.' },
          { id: 'AC-006', date: '2026-05-09T08:14', author: 'Courtney V.', type: 'call', text: 'Called Diane to debrief — interested in next AC Transit electrical RFP.' },
        ] },
      { id: 'PL-009', stage: 'Pre-Qualification',             accountId: 'A-1003', bondType: 'Bid',                   amount: 25000,   obligee: 'Port of Vancouver',     dueDate: '2026-05-13', notes: 'Principal pulled out — equipment shortage',         producer: 'CV', probability: 0,   bidResult: 'no_bid',
        ...
        activity: [
          ...
          { id: 'AC-008', date: '2026-05-13T11:35', author: 'Courtney V.',  type: 'bid_result', subject: 'Result: Principal Did Not Bid', text: 'Logged as no-bid. Marking opp closed.' },
        ] },
    ...
    leads: [
      {
        ...
        activity: [
          ...
          { id: 'LA-002', date: '2026-04-23T11:30', author: 'Courtney V.',     type: 'call',  text: 'Initial call — Tony is interested. Sent introductory email + agency overview.' },
          { id: 'LA-003', date: '2026-05-05T14:10', author: 'Courtney V.',     type: 'meeting', text: 'On-site coffee at Cascade office. Reviewed bonding needs.' },
          { id: 'LA-004', date: '2026-05-12T08:45', author: 'Courtney V.',     type: 'note',  text: 'Qualified — fits Hartford & Liberty appetite. Sending application package next.' },
        ],
        tasks: [
      ...
      },
      {
        ...
        activity: [
          ...
          { id: 'LA-202', date: '2026-04-05T10:20', author: 'Courtney V.',          type: 'call',    text: 'Initial call with Brent — strong interest, requesting capacity up to $15M agg.' },
          { id: 'LA-203', date: '2026-05-02T11:00', author: 'Courtney V.',          type: 'email',   text: 'Sent agency application + indemnity packet via DocuSign.' },
      ...
      },
      {
        ...
        activity: [
          { id: 'LA-301', date: '2026-03-14T16:00', author: 'Courtney V.', type: 'meeting', text: 'Met at AGC Chapter Lunch. Marta open to switching agents.' },
          { id: 'LA-302', date: '2026-04-10T11:00', author: 'Courtney V.', type: 'email',   text: 'Sent application; followed up 4/22.' },
          { id: 'LA-303', date: '2026-05-01T09:00', author: 'Courtney V.', type: 'note',    text: 'Application returned 4/30. Submitted to Hartford + Liberty for parallel quotes.' },
      ...
      },
      {
        ...
        activity: [
          { id: 'LA-401', date: '2026-03-20T10:00', author: 'Courtney V.', type: 'call', text: 'Cold call — needs OR CCB license bond.' },
          { id: 'LA-402', date: '2026-04-18T13:15', author: 'Daniel Park', type: 'email', text: 'Went with an online direct carrier. Closing lead.' },
          { id: 'LA-403', date: '2026-04-18T13:20', author: 'Courtney V.', type: 'note',  text: 'Marked Lost — keep in touch for any growth into commercial roofing later.' },
        ],
        convertedAccountId: null,
      },
      {
        ...
        activity: [
          { id: 'LA-501', date: '2026-04-29T16:00', author: 'Courtney V.', type: 'meeting', text: 'Met at NASBP — Aisha needs a producer that can turn around probate bonds same-day.' },
          { id: 'LA-502', date: '2026-05-02T10:00', author: 'Courtney V.', type: 'email',   text: 'Sent agency overview, NGM brochure, sample probate forms.' },
          { id: 'LA-503', date: '2026-05-08T11:30', author: 'Aisha Rahman', type: 'email', text: 'Approved internally. Reviewing producer agreement.' },
          { id: 'LA-504', date: '2026-05-11T14:00', author: 'Courtney V.', type: 'note',    text: 'Ready to convert to account once agreement is countersigned.' },
        ],
        convertedAccountId: null,
      },
    ],
    underwriting: [
      ...
      ], partnerId: 'P-02', assignedTo: 'Courtney V.', notes: 'Liberty UW requested 12-mo WIP detail' },
      ...
      ], partnerId: 'P-02', assignedTo: 'Courtney V.', notes: '' },
    ],
    documents: [
    ...
    emails: [
      { id: 'E-1', folder: 'inbox', from: 'tom.reyes@hartford-surety.example', subject: 'Re: SF-2024-00121 — Performance bond issued', preview: 'Hi Courtney, attached find the executed performance & payment bonds for Northridge…', date: '2026-03-04T15:12', accountId: 'A-1001', bondId: 'B-2401', read: true },
      { id: 'E-2', folder: 'inbox', from: 'psubramanian@lms.example',         subject: 'BlueWater Marine — UW requests',           preview: 'Courtney, we need the 12-month WIP detail and bank line confirmation before we can issue…', date: '2026-05-09T09:44', accountId: 'A-1004', bondId: 'B-2407', read: false },
...
{{producer_name}}`
    ...
    renewals: [
      ...
      { id: 'R-001', bondId: 'B-2403', status: 'outreach',     decision: null,     newAmount: null,    contactedDate: '2026-05-10', nextFollowUp: '2026-05-17', assignedTo: 'Courtney V.', notes: [
        { date: '2026-05-10', author: 'Courtney V.', text: 'Emailed Mike Trillo asking if McKay HS bid is still active and if performance bond will be needed.' },
        { date: '2026-05-12', author: 'Courtney V.', text: 'Left voicemail with PM at Salem-Keizer SD confirming bond requirement.' },
      ],
        tasks: [
      ...
      { id: 'R-002', bondId: 'B-2407', status: 'decided',      decision: 'increase', newAmount: 1100000, contactedDate: '2026-05-08', nextFollowUp: '2026-05-20', assignedTo: 'Courtney V.', notes: [
        { date: '2026-05-08', author: 'Courtney V.', text: 'Spoke with Greg Adler — Port of Seattle added Phase 2 to the contract, requesting an increase from $875K to $1.1M.' },
        { date: '2026-05-09', author: 'Courtney V.', text: 'Notified Liberty Mutual underwriter; awaiting endorsement.' },
      ] },
      { id: 'R-003', bondId: 'B-2401', status: 'awaiting_response', decision: null, newAmount: null, contactedDate: '2026-05-05', nextFollowUp: '2026-05-19', assignedTo: 'Courtney V.', notes: [
        { date: '2026-05-05', author: 'Courtney V.', text: 'Sent renewal questionnaire to Janet Pierce — need confirmation if SE Division project is still active.' },
      ] },
      { id: 'R-004', bondId: 'B-2405', status: 'upcoming',     decision: null,     newAmount: null,    contactedDate: null,         nextFollowUp: null,         assignedTo: 'Courtney V.', notes: [] },
      { id: 'R-005', bondId: 'B-2408', status: 'upcoming',     decision: null,     newAmount: null,    contactedDate: null,         nextFollowUp: null,         assignedTo: 'Courtney V.', notes: [] },
      { id: 'R-006', bondId: 'B-2409', status: 'decided',      decision: 'release', newAmount: null,    contactedDate: '2026-05-06', nextFollowUp: null,         assignedTo: 'Courtney V.', notes: [
        { date: '2026-05-06', author: 'Courtney V.', text: 'Northridge confirmed library renovation completed and accepted. Obligee letter of release received — bond will be cancelled flat.' },
      ] },
    ],
    intakeForms: [
    ...
    marketing: {
      ...
      emailBlasts: [
        { id: 'MB-1', name: 'April Newsletter — Q2 Bond Market Update',
          ...
          fromName: 'Courtney Vanderbeck', fromEmail: 'casey@vanderbeck-surety.example',
        ...
        { id: 'MB-5', name: 'May Newsletter (draft)',
          subject: '', fromName: 'Courtney Vanderbeck', fromEmail: 'casey@vanderbeck-surety.example',
    ...
    settings: {
      ...
      users: [
        { id: 'U-1', name: 'Courtney Vanderbeck', initials: 'CV', email: 'casey@vanderbeck-surety.example',   role: 'Producer / Admin', color: 'bg-brand-500' },
